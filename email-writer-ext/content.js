...
function createToneSelector() {
    ...
    const tones = ['Professional', 'Friendly', 'Sarcastic', 'Casual', 'Formal'];
...
function injectButton() {
    ...
    button.addEventListener('click', async () => {
        try {
            ...
            const selectedTone = toneSelector.value;  // Get the selected tone
            ...
            const response = await fetch('http://localhost:8080/api/email/generate', {
                ...
                body: JSON.stringify({
                    ...
                    tone: selectedTone  // Send selected tone in the API request
                })
            });
